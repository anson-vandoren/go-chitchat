...
func (user *User) Create() (err error) {
	// Postgres does not automatically return the last insert id, because it would be wront to assume
	...
	// use Query Row to return a row and scan the returned id into the User struct
